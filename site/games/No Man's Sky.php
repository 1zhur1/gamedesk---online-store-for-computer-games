...
$game = [
    ...
    'name' => ' No Mans Sky',
    'price' => 975,  // Цена игры
    'image_url' => '../../img/no-mans-sky (1).jpg',  // Путь к изображению игры
    'description' => 'Встречайте наиболее амбициозный игровой проект современности, о котором так давно трубили журналисты! Наконец-то есть возможность купить No Man’s Sky и посмотреть, да что там посмотреть – покорить, случайно генерируемую вселенную игры, избороздив ее вдоль и поперек на своем супер нафаршированном корабле! Вас ждут дивные события. В такие переделки, как в этом космическом приключенческом боевике, вы еще никогда не попадали, так что активней крутите головой по сторонам, иначе, не ровен час, станете жертвой многочисленных врагов в невиданных доселе формах, которыми новый мир просто кишит.',
    'os' => 'Windows 10',
    'processor' => 'Intel Core i3',
    'ram' => 8,  // В оперативной памяти GB
    'graphics' => 'NVIDIA GTX 770 / AMD Radeon R9 280',
    'disk_space' => 10  // Место на диске в GB
];
?>
