...
$game = [
    ...
    'price' => 835,  // Цена игры
    'image_url' => '../../img/mafia-ii-definitive-edition (1).jpg',  // Путь к изображению игры
    'description' => 'Игра выпущена в HD-разрешении. Станьте гангстером в золотую эпоху организованной преступности. Чтобы расплатиться с долгами отца, герой войны Вито Скалетта связывается с мафией. Он работает вместе со своим приятелем Джо. Совершая преступления, он зарабатывает всё больший авторитет в криминальной семье.',
    'os' => 'Windows 8.1 64-bit',
    'processor' => 'Intel i5-2500K or AMD FX-8120',
    'ram' => 6,  // В оперативной памяти GB
    'graphics' => '2GB NVIDIA GeForce GTX 660 or 2GB AMD Radeon HD7870',
    'disk_space' => 50  // Место на диске в GB
];
?>
