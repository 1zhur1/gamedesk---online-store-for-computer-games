...
$game = [
    ...
    'price' => 615,  // Цена игры
    'image_url' => '../../img/hearts-of-iron-4 (1).jpg',  // Путь к изображению игры
    'description' => 'На военную тематику, и конкретно о происходившем во время Второй Мировой, создавалось и создается немало игр. Однако если вы решили купить Hearts of Iron IV, то получите настоящее удовольствие от стратегического планирования боев, продвинутости системы технологического и политического развития. При ловком владении последней можно умудриться соблюсти нейтралитет. Это одна из немногих военных стратегий, за разработчиков которой не стыдно с первых кадров и в которую хочется играть не отрываясь.',
    'os' => 'Windows 7',
    'processor' => 'Intel Core 2 Quad Q9400 @ 2.66 GHz / AMD Athlon II X4 650 @ 3.20 GHz',
    'ram' => 4,  // В оперативной памяти GB
    'graphics' => 'ATI Radeon HD 5850 or NVIDIA GeForce GTX470 with 1GB VRAM',
    'disk_space' => 2  // Место на диске в GB
];
?>
