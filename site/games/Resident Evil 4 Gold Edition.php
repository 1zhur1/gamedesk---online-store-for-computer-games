...
$game = [
    ...
    'price' => 3295,  // Цена игры
    'image_url' => '../../img/resident-evil-4-gold-edition (1).jpg',  // Путь к изображению игры
    'description' => 'После биологической катастрофы в Раккун-Сити прошло шесть лет. Агента Леона С. Кеннеди, пережившего те события, отправили на задание по спасению похищенной дочери президента. В попытках отыскать ее он оказывается в укромной европейской деревеньке, где с местными жителями творится что-то не то. Сорвите занавес с этой увлекательной и жуткой истории о смелом герое и познайте жизнь и смерть, ужас и восхищение.',
    'os' => 'Windows 10',
    'processor' => 'Intel Core i5-2500K',
    'ram' => 8,  // В оперативной памяти GB
    'graphics' => 'NVIDIA GTX 770 / AMD Radeon R9 280',
    'disk_space' => 30  // Место на диске в GB
];
?>
