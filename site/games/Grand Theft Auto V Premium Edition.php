...
$game = [
    ...
    'price' => 2795,  // Цена игры
    'image_url' => '../../img/grand-theft-auto-v-premium-edition (1).jpg',  // Путь к изображению игры
    'description' => 'Grand Theft Auto V: Premium Edition, грандиозная сага от Rockstar Games и самая высокооцененная игра на текущем поколении консолей, выходит на PC. В версии для PC представлены новые материалы для сюжетного режима, визуальные усовершенствования и другие нововведения.',
    'os' => 'Windows 8.1 64 Bit',
    'processor' => 'Intel Core 2 Q6600 @ 2.40 Ггц',
    'ram' => 4,  // В оперативной памяти GB
    'graphics' => 'NVIDIA 9800 GT c 1 Гб видеопамяти',
    'disk_space' => 72  // Место на диске в GB
];
?>
