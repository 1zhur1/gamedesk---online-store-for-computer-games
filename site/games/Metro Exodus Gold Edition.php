...
$game = [
    ...
    'price' => 589,  // Цена игры
    'image_url' => '../../img/metro-exodus-gold-edition (1).jpg',  // Путь к изображению игры
    'description' => 'Прошло четверть века с тех пор, как ядерная война опустошила землю. Москва лежит в руинах, и несколько тысяч выживших вынуждены бороться за существование в тоннелях метро. Их не убила отравленная природа и мутировавшие чудовища, они пережили сверхъестественный кошмар и ужасы гражданской войны',
    'os' => 'Windows 7/8/10',
    ...
    'disk_space' => 59  // Место на диске в GB
];
?>
